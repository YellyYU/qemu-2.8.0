...
static void vfio_realize(PCIDevice *pdev, Error **errp)
{
    ...
    printf("[Dd] in vfio_realize, flag:1\n");
    dd_stop();
    ...
    printf("[Dd] in vfio_realize, flag:2\n");
    vdev->vbasedev.name = g_strdup(basename(vdev->vbasedev.sysfsdev));
    vdev->vbasedev.ops = &vfio_pci_ops;
    vdev->vbasedev.type = VFIO_DEVICE_TYPE_PCI;

    printf("[Dd] in vfio_realize, flag:3\n");
    ...
    printf("[Dd] in vfio_realize, flag:4\n");
    ...
    printf("[Dd] in vfio_realize, flag:5\n");
    dd_stop();
    ...
    printf("[Dd] in vfio_realize, flag:6\n");
    dd_stop();
    ...
    printf("[Dd] in vfio_realize, flag:7\n");
    dd_stop();
    ...
    printf("[Dd] in vfio_realize, flag:8\n");
    dd_stop();
    ...
    printf("[Dd] in vfio_realize, flag:9\n");
    dd_stop();
    ...
    printf("[Dd] in vfio_realize, flag:10\n");
    ...
    printf("[Dd] in vfio_realize, flag:11\n");
    ...
    printf("[Dd] in vfio_realize, flag:12\n");
    ...
    printf("[Dd] in vfio_realize, flag:13\n");
    dd_stop();
    ...
    printf("[Dd] in vfio_realize, flag:14\n");
    ...
    printf("[Dd] in vfio_realize, flag:15\n");
    ...
    printf("[Dd] in vfio_realize, flag:16\n");
    dd_stop();
    ...
    printf("[Dd] in vfio_realize, flag:17,the end\n");
    return;
...
out_teardown:
    ...
    vfio_bars_exit(vdev);
    printf("[Dd] in vfio_realize, flag:18,failed seems\n");
error:
    error_prepend(errp, ERR_PREFIX, vdev->vbasedev.name);
    printf("[Dd] in vfio_realize, flag:19,failed seems\n");
}
